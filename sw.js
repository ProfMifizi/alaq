/* ALAQ service worker — hors ligne complet
   ...
   - le cœur (app.css, assets.js, trace-lettres.js, content/unites.js, polices.css, moteur U8 — la liste CORE) : cache
...
const CACHE='alaq-v198-2026-09-07';  // L'APP : versionné, purgé à chaque livraison
...
const CORE=['.','index.html','u8/u8.js','u8/u8.css','app.css','assets.js','trace-lettres.js','content/unites.js','confidentialite.html','polices/polices.css','manifest.webmanifest','icon-192.png','icon-512.png','apple-touch-icon.png'];
